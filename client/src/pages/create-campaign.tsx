...
const formSchema = z.object({
  ...
  milestones: z.array(z.object({ 
    ...
    releasePercentage: z.number().min(1).max(100),
...
const CreateCampaign = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      // Only create campaign in backend
              ...
              <div className="space-y-6">
                ...
                <div className="mb-4">
                  <MilestoneManager
                    ...
                    onChange={(milestones) => form.setValue('milestones', milestones)}
                    totalTarget={form.watch('target') || '0'}
                  />
                </div>
                {/* Team */}
                <div className="mb-4">
