          ...
          milestones: JSON.stringify([
            {
              ...
              description: "Complete land survey, permits, and site preparation for solar panel installation",
              targetAmount: "1.0",
            ...
            },
            {
              ...
              description: "Install solar panels and connect to the community grid",
              targetAmount: "3.0",
            ...
            },
            {
              ...
              description: "Complete community center construction and open to public",
              targetAmount: "5.0",
...
(async () => {
  ...
  // Start the campaign scraper scheduler
  try {
    const { campaignScheduler } = await import('./services/scheduler');
    campaignScheduler.start(30); // Run every 30 minutes
    console.log('Campaign scraper scheduler started');
  } catch (error) {
    console.error('Failed to start campaign scraper scheduler:', error);
  }
