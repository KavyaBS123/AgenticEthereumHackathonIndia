...
export const campaigns = pgTable("campaigns", {
  ...
  milestones: text("milestones", { mode: "json" }), // New field for milestone-based fund release
  ...
  impactMeter: text("impact_meter", { mode: "json" }) // UN SDG goals alignment score (0-5)
});
